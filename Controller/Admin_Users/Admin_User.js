...
const post_admin_user = (req, res) => {
    try {
        ...
        let SqlQuery = "INSERT INTO tbl_admin_users SET ?"
...
rohitsingh998195@gmail.com
+91 7879441406
MP Nagar Zone-1,Bhopal-462001`
                    };
...
const get_admin_user_list = (_req, res) => {
    try {
        let SqlQuery = "SELECT * FROM tbl_admin_users"
...
const delete_admin_user = (req, res) => {
    try {
        ...
        console.log(id)
        let SqlQuery = 'DELETE FROM tbl_admin_users WHERE uid=?'
...
const update_admin_user = (req, res) => {
    // try {
        ...
        console.log(data)
        let id = req.params.id
        let SqlQuery = `UPDATE tbl_admin_users SET ? WHERE uid =?`
...
const status_admin_user = (req, res) => {
    try {
        ...
        let id = req.params.id
        // console.log(status)
        let SqlQuery = 'UPDATE tbl_admin_users SET status =? WHERE uid =?'
...
const find_admin_userbyuid = (req, res) => {
    try {
        ...
        let SqlQuery = 'SELECT * FROM tbl_admin_users WHERE uid =?'
